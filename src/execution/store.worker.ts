...
import { consumeApprovalInTransaction, type ConsumeApprovalFailure } from "../approval/store.worker.js";
import type {
  ExecutionRecord,
  ExecutionReconcileContext,
  ExecutionStatus,
} from "../types.js";
import { executionContext } from "../worker/db/db.worker.js";

function checkCancel() {
  if (executionContext.getStore()?.isCancelled()) {
